...
export function view<M>(config: {
  ...
  const { dims: { width: W, height: H }, margins: { top: MT, right: MR, left: ML }, pw: PW, ph: PH } = model.layout;
      ...
      [
        ...
        ...cells.map((cell) => {
          ...
          return h.g(
            ...
            [
              h.rect([
                h.X(String(x + pad)), h.Y(String(y + pad)),
                h.Width(String(tileSize - pad * 2)), h.Height(String(tileSize - pad * 2)),
                h.Fill(color),
        ...
        h.g(
          ...
          [
            ...
            ...Array.from({ length: legendSteps }, (_, i) => {
              ...
              return h.rect([
                h.X('0'), h.Y(String(y)),
                h.Width('10'), h.Height(String(stepH)),
                h.Fill(colorScale(v)),
              ], []);
            }),
            // Min label
            h.text([
              h.X('14'), h.Y(String(legendH)),
              h.Style({ 'font-size': '0.6rem', 'dominant-baseline': 'middle',
            ...
            ...(legendLabel ? [h.text([
              ...
              h.Style({ 'text-anchor': 'middle', 'font-size': '0.6rem',
