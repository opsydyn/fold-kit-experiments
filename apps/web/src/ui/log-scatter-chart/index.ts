...
export const Message = defineMessageUnion({
  HoveredPoint: { label: Schema.String },
  BlurredPoint: {},
});
...
export const update = (model: Model, msg: Message): Return =>
  Message.match(msg, {
    HoveredPoint: ({ label }) => ({ model: { ...model, activeLabel: Option.some(label) } }),
    BlurredPoint: () => ({ model: { ...model, activeLabel: Option.none() } }),
  });
      ...
      [
        ...
        h.g(
          ...
          points.map((pt) => {
            ...
            return h.g(
              [
                h.OnMouseEnter(toParentMessage(Message.HoveredPoint({ label: pt.label }))),
