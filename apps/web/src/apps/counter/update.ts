...
const directionalBurst = (hue: Hue, angleBase: number): ReadonlyArray<Command.Command<Message>> =>
  Arr.makeBy(BURST_COUNT, () => SpawnParticle({ x: SPAWN_X, y: SPAWN_Y, hue, angleBase }));
